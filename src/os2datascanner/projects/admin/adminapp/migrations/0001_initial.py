# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-06-12 13:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ExchangeDomain',
            fields=[
                ('domain_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='os2datascanner.Domain')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domains', models.ManyToManyField(related_name='exchangedomains', to='os2datascanner.ExchangeDomain', verbose_name='Exchangedomæner')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('scanner_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='os2datascanner.Scanner')),
                ('domains', models.ManyToManyField(related_name='filedomains', to='os2datascanner.FileDomain', verbose_name='Fildomæner')),
            ],
            bases=('os2datascanner.scanner',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domains', models.ManyToManyField(related_name='webdomains', to='os2datascanner.WebDomain', verbose_name='Webdomæner')),
            ],
            bases=('os2datascanner.scanner',),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='scan',
            name='domains',
            field=models.ManyToManyField(to='os2datascanner.Domain', verbose_name='Domæner'),
        ),
        migrations.AddField(
            model_name='scan',
            name='recipients',
        ...
        migrations.AddField(
            model_name='domain',
            name='authentication',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='os2datascanner_domain_authentication', to='os2datascanner.Authentication', verbose_name='Brugernavn'),
        ),
        migrations.AddField(
            model_name='domain',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='os2datascanner_domain_groups', to='os2datascanner.Group', verbose_name='Gruppe'),
        ),
        migrations.AddField(
            model_name='domain',
            name='organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='os2datascanner_domain_organization', to='os2datascanner.Organization', verbose_name='Organisation'),
        ),
        migrations.AddField(
